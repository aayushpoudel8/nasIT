...
const Mission = () => {
  return (
    <div className="flex flex-col justify-center items-center  mx-auto font-inter py-5">
      <div>
        <h3 className="text-[#DD0C39] w-full text-[18px] uppercase mb-3 text-center font-inter font-[600] text-base ">
          Mission
        </h3>
      </div>
      <div>
      ...
      <div className="container mt-6 font-inter grid  grid-cols-6 md:grid-cols-12 mb-9 px-4 md:px-10 gap-8 md:gap-10 justify-center mx-auto align-middle text-center">
        <div className="col-span-6 md:col-span-6 xl:col-span-4 items-center">
          ...
          <div className="">
            <h3 className="font-[500] text-[20px] text-center text-[#101828]">
              Advocacy and policy
            </h3>
