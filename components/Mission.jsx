...
const Mission = () => {
  return (
    <div className="flex flex-col justify-center items-center py-[90px] gap-[64px] px-[72px] mb-8 font-inter">
      <div className="w-full flex justify-center items-center">
        <h3 className="text-[#DD0C39] text-center text-base uppercase">Mission</h3>
      </div>
      <div>
        <p className="text-[#101828] text-xl text-center font-bold w-[768px] mx-auto">
      ...
      <div className="container grid grid-cols-12 gap-6 justify-center mx-auto align-middle text-center">
        <div className="col-span-4">
          ...
          <div className="">
            ...
            <p className="font-light text-sm text-[#667085]">
              Advocating, lobbying and promoting policies that benefit the
              software industry and oppose harmful regulations.
            </p>
          </div>
        </div>
        <div className="col-span-4 items-center">
          ...
          <div className="mx-auto">
            ...
            <p className="font-light text-sm text-[#667085]">
              Building the infrastructure, ecosystem to foster innovation and
              research and support entrepreneurs in the software industry..
            </p>
          </div>
        </div>
        <div className="col-span-4 items-center">
        ...
        <div className="col-span-4 items-center">
          ...
          <div className="mx-auto">
            ...
            <p className="font-light text-sm text-[#667085]">
              Promoting the export of software products and services and working
              with international organizations and governments to develop new
        ...
        <div className="col-span-4 items-center">
          ...
          <div className="mx-auto">
            ...
            <p className="font-light text-sm text-[#667085]">
              Promoting education and training programs for software developers
              and other professionals to build a competitive workforce.
            </p>
          </div>
        </div>
        <div className="col-span-4 items-center">
          ...
          <div className="mx-auto">
            ...
            <p className="font-light text-sm text-[#667085]">
              Encourage collaboration and partnership within the software
              industry and with other industries and with other national &
